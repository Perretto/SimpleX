(function($) {
    $.fn.tree_structure = function(options) {
        ...
        return this.each(function() {
            ...
            var add_action_text = add_option == true ? '<span class="add_action" title="Adicionar"></span>' : '';
            var edit_action_text = edit_option == true ? '<span class="edit_action" title="Editar"></span>' : '';
            var delete_action_text = delete_option == true ? '<span class="delete_action" title="Deletar"></span>' : '';
            ...
            if (add_option) {
                $(document).on("click", '.' + class_name + ' span.add_action', function() {
                    ...
                    if (_this.closest('div').children('form.add_data').length == 0) {
                        var addquery = '<form class="add_data" method="post" action=""><img class="close" src="./../../Images/close.png" /><input type="text" class="first_name" name="first_name" placeholder="Mensagem"><input type="checkbox" name="showhideval" id="hide" /><label for="hide">Esconder filhos</label><input type="submit" class="submit" name="submit" value="Ok"></form>';
...
//                        });
            ...
            if (edit_option) {
                $(document).on("click", '.' + class_name + ' span.edit_action', function() {
                    ...
                    var _this = $(this);
                    var editquery = '<form class="edit_data" method="post" action=""><img class="close" src="./../../Images/close.png" /><input type="text" class="first_name" name="first_name" value="" placeholder="Mensagem"><input type="checkbox"  value="" name="showhideval" id="hide" /><label for="hide">Esconder filhos</label><input type="submit" class="edit" name="submit" value="Ok"></form>';
            ...
            if (delete_option) {
                $(document).on("click", '.' + class_name + ' span.delete_action', function() {
                    ...
                    if (confirm_before_delete) {
                        var confirm_text = $(this).closest('li').children('ul').length === 0 ? "Deseja deletar este item ?" : "Deseja deletar todos os itens abaixo deste ?";
